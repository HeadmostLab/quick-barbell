...
public class CurlyBarScene extends AssembledBarScene {

    private AssembledBar assembledBar;

    public CurlyBarScene(AssembledBar assembledBar, HLRect viewPort, Context context, Loader loader, int lightColor) {
